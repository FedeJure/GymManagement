    ...
    <Card fluid color="teal">
      <Card.Content>
        <List.Content floated="right">
          ...
          >
            <Icon name="dollar"></Icon>Crear orden de cobro
          </Button>
          <Button
            inverted
            secondary
          ...
          >
            <Icon name="trash"></Icon>Borrar
          </Button>
        </List.Content>
        <List.Content floated="right">
          <Button onClick={() => handleDetails()} primary icon compact>
            <Icon name="file alternate outline"></Icon>Ver Detalle
          </Button>
        </List.Content>
        ...
        <List.Content floated="left">
          {subscription.product.name} {subscription.user.lastname},{" "}
          {subscription.user.name} Desde{" "}
          {subscription.initialTime.toLocaleDateString()}{" "}
        </List.Content>
        {subscription.endTime ? (
          <List.Content floated="left">
            Hasta {subscription.endTime.toLocaleDateString()}
          </List.Content>
        ) : (
