...
const _CreateProductModal: React.FC<ICreateProductModal> = ({
  onClose,
  onSubmit,
  initialData,
  initialOwners = [],
}) => {
  const { items: users, setFilterByContent, setFilterByTag } = useUsers();
  ...
  useEffect(() => {
    setFilterByTag([UserType.TRAINER]);
  }, []);
  ...
  //     <Modal.Header>
  //       {initialData ? "Edición de producto" : "Creación de producto"}
  //     </Modal.Header>
  //     <Modal.Content image>
  ...
  //                   onChange={(v) =>
  //                     handleChange(v.currentTarget.value, "price")
  //                   }
  //                 />
  //               </Form.Field>
  //               <Form.Field>
  ...
  //               <Form.Field
  //                 error={
  //                   submitted && formData.daysInWeek.length == 0
  //                     ? {
  ...
  //                   }))}
  //                   onChange={(e, data) =>
  //                     handleChange(data.value, "daysInWeek")
  //                   }
  //                 />
  //               </Form.Field>
  //               <Form.Field>
  //                 <label>Profesor / Profesores</label>
  //                 <Dropdown
  //                   fluid
  //                   selection
  //                   search
  ...
  //             <Grid.Column verticalAlign="middle">
  //               <label>
  //                 Importante: Los siguientes descuentos se refiere a la cantidad
  //                 total de actividades entre todos los familiares (Ej: Si un
  //                 alumno tiene 1 actividad y su hermano tiene 2 actividades, el
  //                 descuento seria por 3 actividades)
  //               </label>
  //               <Form.Field>
  ...
  //                         handleDiscountChange(
  //                           target.currentTarget.value,
  //                           "fiveOrMoreSubscriptionsDiscount"
  //                         )
  //                       }
...
export const CreateProductModal: React.FC<ICreateProductModal> = (props) => (
  <UserProvider>
    <_CreateProductModal {...props} />
  </UserProvider>
);
