...
export const OrderCard = ({ order, handleCancel, handleGenerate }: { order: Order, handleCancel: Function, handleGenerate: Function }) => (
        ...
        <Card fluid color="teal">
            <Card.Content>
                {order.amountPayed <= 0 && !order.cancelled && !order.completed && <List.Content floated='right'>
                    <Button icon compact primary onClick={() => handleGenerate()}><Icon name="payment"></Icon> Generar pago</Button>
